...
path = r'H:\WORKGROUP\Montage\PublicGroup\GERAET\IMG\PG3\LXG445'
path = r'H:\HOME\BERLIN USER\Bergmann, Sven Gerd\Private\Python\Test'
output = r'C:\Users\sbergmann\Desktop'
# output = r'H:\WORKGROUP\Montage\PublicGroup\GERAET\IMG\PG3\LXG445\python\outputs'
prefix = 'HWC'
planetime = ['20201015','20201020']
dt = timedelta(minutes=5)

dtformat = '%Y%m%d'
time = [datetime.strptime(t,dtformat) for t in planetime]

block = 'HWC_AU_Hardware'
